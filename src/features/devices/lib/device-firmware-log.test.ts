...
const releases: FirmwareRelease[] = [
  { version: "v2.4.0", date: "2025-12-10", region: "All regions", deviceType: "Freestyle Hands-free", status: "active", devices: 10, notes: "Battery" },
  { version: "v2.3.1", date: "2025-09-04", region: "Europe", deviceType: "Freestyle Hands-free", status: "superseded", devices: 8, notes: "EU patch" },
  { version: "v2.3.0", date: "2025-07-18", region: "All regions", deviceType: "Freestyle Hands-free", status: "superseded", devices: 8, notes: "OTA engine" },
  { version: "v2.3.1", date: "2025-09-04", region: "Europe", deviceType: "Symphony", status: "superseded", devices: 2, notes: "Wrong model" },
  { version: "v2.0.0", date: "2024-06-01", region: "Europe", deviceType: "Freestyle Hands-free", status: "recalled", devices: 0, notes: "Recalled" },
];
